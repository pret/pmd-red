...
void SmeargleRescueDialogue(void)
{
    ...
    smeargleEntity = GetEntityFromMonsterBehavior(BEHAVIOR_SMEARGLE);
    CutsceneLookAroundEffect_Async(smeargleEntity);
    DungeonWaitFrames_Async(0xA, 0x46);
    // Ohhh...
    // I've lost my bearings
    DisplayDungeonDialogue_Async(&gSmeargleRescueDialogue_1);
    DungeonWaitFrames_Async(0xA, 0x46);
    CutsceneLookDir_Async(smeargleEntity, 4, DIR_TRANS_SPINLEFT1, DIRECTION_NORTH);
    DungeonWaitFrames_Async(0xA, 0x46);
    // I can't get out...
    // I'm hungry...
    // I'm in trouble
    DisplayDungeonDialogue_Async(&gSmeargleRescueDialogue_2);
    DungeonWaitFrames_Async(0xA, 0x46);
    sub_8086448();
    sub_8086598();
    ...
    DungeonWaitFrames_Async(0x20, 0x46);
    CutsceneLookDir_Async(smeargleEntity, 4, DIR_TRANS_SPINLEFT1, DIRECTION_SOUTH);
    // Oh! You are?
    DisplayDungeonDialogue_Async(&gSmeargleRescueDialogue_3);
    DungeonWaitFrames_Async(0xA, 0x46);
    ...
    DisplayDungeonDialogue_Async(&gSmeargleRescueDialogue_4);
    DungeonWaitFrames_Async(0xA, 0x46);
