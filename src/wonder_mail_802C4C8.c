...
bool8 sub_802C4C8(s32 a0, UnkTextStruct2_sub *a1, u32 a2)
{
    ...
    gUnknown_203B2E8->unk8.s0.unk38 = &gUnknown_203B2E8->unk8.s0.unk3C.a0[a0];
    RestoreUnkTextStruct_8006518(&gUnknown_203B2E8->unk8.s0.unk3C);

    gUnknown_203B2E8->unk8.s0.unk3C.a0[gUnknown_203B2E8->unk8.s0.unk34] = sUnknown_80DFCFC;
    gUnknown_203B2E8->unk8.s0.unk38->unk14 = &gUnknown_203B2E8->unk8.unk9C;

    if (a1 != NULL)
        gUnknown_203B2E8->unk8.s0.unk3C.a0[gUnknown_203B2E8->unk8.s0.unk34].unk8 = *a1;
...
void sub_802C688(void)
{
    if (gUnknown_203B2E8 != NULL) {
        ...
        gUnknown_203B2E8->unk8.s0.unk3C.a0[gUnknown_203B2E8->unk8.s0.unk34] = sUnknown_80DFCE4;
        ResetUnusedInputStruct();
        xxx_call_save_unk_text_struct_800641C(&gUnknown_203B2E8->unk8.s0.unk3C, TRUE, TRUE);
