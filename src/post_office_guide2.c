...
bool8 sub_80319A4(u8 param_1, u8 dungeon, s32 param_3)
{
    ...
    sUnknown_203B330->unk14 = &sUnknown_203B330->unk18.a0[param_3];
    sub_8031A2C();
    return TRUE;
}
...
void sub_8031A3C(void)
{
    if (sUnknown_203B330 != NULL) {
        sUnknown_203B330->unk18.a0[sUnknown_203B330->unk10] = sUnknown_80E1EFC;
...
static void sub_8031A84(void)
{
    ...
    sUnknown_203B330->unk18.a0[sUnknown_203B330->unk10] = sUnknown_80E1F18;
