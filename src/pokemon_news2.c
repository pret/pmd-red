...
bool8 sub_802B9FC(u8 mailIndex)
{
    ...
    sUnknown_203B2D4->unk28.a0[1] = sUnknown_80DFC18;
    sUnknown_203B2D4->unk28.a0[2] = sUnknown_80DFC18;
    sUnknown_203B2D4->unk28.a0[3] = sUnknown_80DFC18;
...
void sub_802BACC(void)
{
    if (sUnknown_203B2D4 != NULL) {
        sUnknown_203B2D4->unk28.a0[sUnknown_203B2D4->unk24] = sUnknown_80DFC18;
        ResetUnusedInputStruct();
        xxx_call_save_unk_text_struct_800641C(&sUnknown_203B2D4->unk28, TRUE, TRUE);
