...
typedef struct unkStruct_203B280
{
...
EWRAM_DATA_2 unkStruct_203B280 *gUnknown_203B280 = {0};
...
typedef struct unkStruct_203B28C
{
...
EWRAM_DATA_2 unkStruct_203B28C *gUnknown_203B28C = {0};

// split3

static EWRAM_DATA_2 WigglytuffShop *sWigglytuffShop = {0};
...
bool8 sub_80211AC(u32 mode, u32 param_2)
{
    ...
    gUnknown_203B280 = MemoryAlloc(sizeof(unkStruct_203B280), 8);
...
{
    gUnknown_203B28C = MemoryAlloc(sizeof(unkStruct_203B28C), 8);
...
bool8 CreateWigglytuffShop(bool32 isAsleep)
{
    ...
    sWigglytuffShop = MemoryAlloc(sizeof(WigglytuffShop), 8);
    sWigglytuffShop->menuAction1 = 0;
    sWigglytuffShop->menuAction2 = 0;
    sWigglytuffShop->isAsleep = isAsleep;
    ...
    if (sWigglytuffShop->isAsleep == TRUE) {
        sWigglytuffShop->unkCC = NULL;
    }
    else {
        sWigglytuffShop->unkCC = &sWigglytuffShop->faceFile;
    }
    file = GetDialogueSpriteDataPtr(MONSTER_WIGGLYTUFF);
    sWigglytuffShop->faceFile = file;
    sWigglytuffShop->faceData = file->data;
    sWigglytuffShop->unkC8 = 0;
    sWigglytuffShop->unkC9 = 0;
    sWigglytuffShop->unkCA = 0;
    sWigglytuffShop->unkC4 = 2;
    sWigglytuffShop->unkC6 = 8;
...
void sub_8021D1C(void)
{
    if(sWigglytuffShop)
    {
        CloseFile(sWigglytuffShop->faceFile);
        MemoryFree(sWigglytuffShop);
        sWigglytuffShop = NULL;
    }
}

void SetWigglytuffState(s32 newState)
{
    sWigglytuffShop->state = newState;
    sub_8021D5C();
...
void sub_8021D5C(void) 
{
    ...
    sub_8006518(sWigglytuffShop->unkD0);
    switch(sWigglytuffShop->state)
    {
        case WIGGLYTUFF_UNK9:
        case WIGGLYTUFF_UNKA:
            sWigglytuffShop->unkD0[0] = gUnknown_80DC534;
            sWigglytuffShop->unkD0[2] = gUnknown_80DC534;
            sWigglytuffShop->unkD0[1] = gUnknown_80DC564;
            break;
        case WIGGLYTUFF_UNKB:
            sWigglytuffShop->unkD0[2] = gUnknown_80DC54C;
            break;
        default:
            for(index = 0; index < 4; index++)
            {
                sWigglytuffShop->unkD0[index] = gUnknown_80DC534;
            }
            break;
    
    }
    ResetUnusedInputStruct();
    sub_800641C(sWigglytuffShop->unkD0, TRUE, TRUE);
}
...
void UpdateWigglytuffDialogue(void)
{
    ...
    switch(sWigglytuffShop->state) 
    {
        case WIGGLYTUFF_INIT:
            sub_80222C8();
            sub_8014248(gCommonWigglytuff[sWigglytuffShop->isAsleep][0],0,sWigglytuffShop->menuAction1,sWigglytuffShop->unk1C,sWigglytuffShop->unk5C,4,0,sWigglytuffShop->unkCC,0xc);
            break;
        case WIGGLYTUFF_MAIN_MENU:
            sub_80222C8();
            sub_8014248(gCommonWigglytuff[sWigglytuffShop->isAsleep][1],0,sWigglytuffShop->menuAction1,sWigglytuffShop->unk1C,sWigglytuffShop->unk5C,4,0,sWigglytuffShop->unkCC,0xc);
            break;
        case FRIEND_AREA_SELECT_BUY:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_UNK9;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][3],0,sWigglytuffShop->unkCC,0x10d); 
            break;
        case FRIEND_AREA_SELECT_BUY_AGAIN:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_UNKA;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][4],0,sWigglytuffShop->unkCC,0x10d); 
            break;
        case WIGGLYTUFF_INFO:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_MAIN_MENU;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][19],0,sWigglytuffShop->unkCC,0x10d); 
            break;
        case WIGGLYTUFF_PRE_EXIT:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_EXIT;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][2],0,sWigglytuffShop->unkCC,0x30d);
            break;
        default:
            break;
        case WIGGLYTUFF_CANT_ADD_FRIEND_AREA:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_PRE_EXIT;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][8],0,sWigglytuffShop->unkCC,0x10d); 
            break;
        case NO_MONEY:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_UNKA;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][9],0,sWigglytuffShop->unkCC,0x10d); 
            break;
        case NO_FRIEND_AREAS:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_PRE_EXIT;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][10],0,sWigglytuffShop->unkCC,0x10d); 
            break;
        case NOT_ENOUGH_MONEY:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_UNKA;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][11],0,sWigglytuffShop->unkCC,0x10d); 
            break;
        case WIGGLYTUFF_UNK9:
            sub_80211AC(2,3);
            DrawTeamMoneyBox(1);
        ...
        case WIGGLYTUFF_UNKB:
            ...
            DrawTeamMoneyBox(1);
            sub_8022380();
            sub_8012D60(&sWigglytuffShop->unk6C,sWigglytuffShop->unk1C,0,sWigglytuffShop->unk5C, sWigglytuffShop->menuAction2,2);
            break;
        case BUY_FRIEND_AREA:
            CreateWigglytuffConfirmFriendAreaMenu();
            sub_8092578(gUnknown_202E628,sWigglytuffShop->chosenFriendArea,FALSE);
            gUnknown_202DE30[0] = sWigglytuffShop->friendAreaPrice;
            sub_8014248(gCommonWigglytuff[sWigglytuffShop->isAsleep][5],0,5,sWigglytuffShop->unk1C,0,4,0,sWigglytuffShop->unkCC,0xc);
            break;
        case FRIEND_AREA_INFO:
            sub_8021774(sWigglytuffShop->chosenFriendArea,FALSE,2);
            break;
        case CONFIRM_BUY_FRIEND_AREA:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_UNKD;
            sub_8092578(gUnknown_202E628,sWigglytuffShop->chosenFriendArea,FALSE);
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][6],0,sWigglytuffShop->unkCC,0x10d); 
            break;
        case WIGGLYTUFF_UNKD:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_UNKE;
            PlaySound(0x25b);
            sWigglytuffShop->unk130 = 1;
            break;
        case WIGGLYTUFF_UNKE:
            sWigglytuffShop->fallbackState = FRIEND_AREA_UNLOCKED;
            sWigglytuffShop->unk134 = 30;
            break;
        case FRIEND_AREA_UNLOCKED:
            if (sub_8021700(2) != 0) {
                sub_80213A0();
                sWigglytuffShop->fallbackState = NO_FRIEND_AREAS;
            }
            else {
                sWigglytuffShop->fallbackState = FRIEND_AREA_SELECT_BUY_AGAIN;
            }
            PlaySound(0xce);
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][7],0,sWigglytuffShop->unkCC,0x10d);
            break;
        case WIGGLYTUFF_CHECK:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_UNK16;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][12],0,sWigglytuffShop->unkCC,0x10d); 
            break;
        case WIGGLYTUFF_CHECK_AGAIN:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_UNK17;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][13],0,sWigglytuffShop->unkCC,0x10d); 
            break;
        case WIGGLYTUFF_UNK16:
        ...
        case DISPLAY_POKEMON_FRIEND_AREA_INFO:
            sub_8092638(sWigglytuffShop->chosenFriendArea,&uStack_14,FALSE,FALSE);
            if (uStack_14.hasFriendArea) {
                sWigglytuffShop->fallbackState = WIGGLYTUFF_CHECK_HAS_FRIEND_AREA;
            }
            else
            {
                switch(GetFriendAreaUnlockCondition(sWigglytuffShop->chosenFriendArea))
                {
                    case UNLOCK_SHOP_POST_GAME:
                        if (sub_80023E4(6) != 0) {
                            sWigglytuffShop->fallbackState = WIGGLYTUFF_CHECK_AGAIN;
                        }
                        else {
                            sWigglytuffShop->fallbackState = WIGGLYTUFF_CHECK_POST_GAME;
                        }
                        break;
                    case UNLOCK_WONDER_MAIL:
                        sWigglytuffShop->fallbackState = WIGGLYTUFF_CHECK_WONDER_MAIL;
                        break;
                    case UNLOCK_LEGENDARY_REQUEST:
                        sWigglytuffShop->fallbackState = WIGGLYTUFF_CHECK_LEGENDARY;
                        break;
                    default:
                        sWigglytuffShop->fallbackState = WIGGLYTUFF_CHECK_AGAIN;
                        break;
            ...
            string = GetMonSpecies(sWigglytuffShop->chosenSpecies);
            strcpy(gAvailablePokemonNames,string);
            sub_8092578(gUnknown_202E628,sWigglytuffShop->chosenFriendArea,FALSE);
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][14],0,sWigglytuffShop->unkCC,0x10d);
            break;
        case WIGGLYTUFF_CHECK_HAS_FRIEND_AREA:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_CHECK_AGAIN;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][15],0,sWigglytuffShop->unkCC,0x10d);
            break;
        case WIGGLYTUFF_CHECK_POST_GAME:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_CHECK_AGAIN;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][16],0,sWigglytuffShop->unkCC,0x10d);
            break;
        case WIGGLYTUFF_CHECK_WONDER_MAIL:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_CHECK_AGAIN;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][17],0,sWigglytuffShop->unkCC,0x10d);
            break;
        case WIGGLYTUFF_CHECK_LEGENDARY:
            sWigglytuffShop->fallbackState = WIGGLYTUFF_CHECK_AGAIN;
            sub_80141B4(gCommonWigglytuff[sWigglytuffShop->isAsleep][18],0,sWigglytuffShop->unkCC,0x10d);
            break;
    }
}
...
void sub_80222C8(void)
{
    s32 i;
    s32 index = 0;
    MemoryFill16(sWigglytuffShop->unk5C, 0, sizeof(sWigglytuffShop->unk5C));
    sWigglytuffShop->unk1C[index].text = *gCommonBuy;
    sWigglytuffShop->unk1C[index].menuAction = 2;
    index++;
    sWigglytuffShop->unk1C[index].text = *gCommonCheck;
    sWigglytuffShop->unk1C[index].menuAction = 3;
    index++;
    sWigglytuffShop->unk1C[index].text = *gCommonInfo;
    sWigglytuffShop->unk1C[index].menuAction = 4;
    index++;
    sWigglytuffShop->unk1C[index].text = *gCommonCancel;
    sWigglytuffShop->unk1C[index].menuAction = 1;
    index++;
    sWigglytuffShop->unk1C[index].text = NULL;
    sWigglytuffShop->unk1C[index].menuAction = 1;

    for(i = 0; i < index; i++)
    {
        if(sWigglytuffShop->unk5C[i] == 0 && sWigglytuffShop->unk1C[i].menuAction == sWigglytuffShop->menuAction1)
            return;
    }
    for(i = 0; i < index; i++)
    {
        if(sWigglytuffShop->unk5C[i] == 0)
        {
            sWigglytuffShop->menuAction1 = sWigglytuffShop->unk1C[i].menuAction;
            break;
        }
    }
}
...
void sub_8022380(void)
{
    ...
    for(i = 0; i < index; i++)
    {
        if(sWigglytuffShop->unk5C[i] == 0 && sWigglytuffShop->unk1C[i].menuAction == sWigglytuffShop->menuAction2)
            return;
    }
    for(i = 0; i < index; i++)
    {
        if(sWigglytuffShop->unk5C[i] == 0)
        {
            sWigglytuffShop->menuAction2 = sWigglytuffShop->unk1C[i].menuAction;
            break;
        }
    }
}
...
void CreateWigglytuffConfirmFriendAreaMenu(void)
{
    s32 index = 0;
    MemoryFill16(sWigglytuffShop->unk5C, 0, sizeof(sWigglytuffShop->unk5C));
    sWigglytuffShop->unk1C[index].text = *gCommonYes;
    sWigglytuffShop->unk1C[index].menuAction = 5;
    index++;
    sWigglytuffShop->unk1C[index].text = *gCommonNo;
    sWigglytuffShop->unk1C[index].menuAction = 6;
    index++;
    sWigglytuffShop->unk1C[index].text = NULL;
    sWigglytuffShop->unk1C[index].menuAction = 1;
}
...
void sub_8022460(void)
{
    ...
    {
        if (menuAction != 1) {
            sWigglytuffShop->menuAction1 = menuAction;
        }
        switch(menuAction)
        {
            case 2:
...
void HandleWigglytuffConfirmFriendAreaMenu(void)
{
    ...
    if (sub_80144A4(&menuAction) == 0) {
        ...
        {
            case 5:
                gTeamInventoryRef->teamMoney -= sWigglytuffShop->friendAreaPrice;
                UnlockFriendArea(sWigglytuffShop->chosenFriendArea);
                PlaySound(0x14C);
...
void sub_8022538(void)
{
    ...
    {
        case 3:
            sWigglytuffShop->chosenFriendArea = sub_802132C();
            sWigglytuffShop->friendAreaPrice = GetFriendAreaPrice(sWigglytuffShop->chosenFriendArea);
...
void sub_80225C8(void)
{
    s32 menuAction = 0;
    sub_8021274(FALSE);
    if(sub_8012FD8(&sWigglytuffShop->unk6C) == 0)
    {
        sub_8013114(&sWigglytuffShop->unk6C, &menuAction);
        if(menuAction != 1) sWigglytuffShop->menuAction2 = menuAction;
    }
    switch(menuAction)
    {
        case 2:
            ...
            else if(sWigglytuffShop->friendAreaPrice > gTeamInventoryRef->teamMoney)
            {
...
void sub_8022684(void)
{
    ...
    {
        case 3:
            sWigglytuffShop->chosenSpecies = sub_802331C();
            sWigglytuffShop->chosenFriendArea = GetFriendArea(sWigglytuffShop->chosenSpecies);
...
void sub_80226CC(void)
{
    ...
    if (sub_80144A4(&temp) == 0)
        SetWigglytuffState(sWigglytuffShop->fallbackState);
}
...
void sub_80226F0(void)
{
    ...
    if(sub_8099B94() == 0)
    {
        switch(sWigglytuffShop->unk130)
        {
            ...
            default:
                SetWigglytuffState(sWigglytuffShop->fallbackState);
                sWigglytuffShop->unk130 = 0;
                break;
        }
        sWigglytuffShop->unk130++;
    }
}

void sub_8022790(void)
{
    if (sWigglytuffShop->unk134 != 0)
        sWigglytuffShop->unk134--;
    else
        SetWigglytuffState(sWigglytuffShop->fallbackState);
}
