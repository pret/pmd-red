...
static void sub_8017F28(void)
{
    ...
    switch (sUnknown_203B20C->state) {
        case KANGASKHAN_STORAGE_2_MAIN:
            sUnknown_203B20C->unkF0.a0[0] = sUnknown_80DB7B8;
            sUnknown_203B20C->unkF0.a0[1] = sUnknown_80DB7B8;
            sUnknown_203B20C->unkF0.a0[0] = sUnknown_80DB7B8;
            BuildKangaskhanStorage2MainMenu();
            sUnknown_203B20C->unkF0.a0[2] = sUnknown_80DB7D0;
            sub_8012CAC(&sUnknown_203B20C->unkF0.a0[2], sUnknown_203B20C->unk20);
            break;
        case 4:
        case 5:
            sUnknown_203B20C->unkF0.a0[0] = sUnknown_80DB7B8;
            sUnknown_203B20C->unkF0.a0[1] = sUnknown_80DB7B8;
            sUnknown_203B20C->unkF0.a0[2] = sUnknown_80DB7B8;
            sUnknown_203B20C->unkF0.a0[0] = sUnknown_80DB7B8;
            break;
        case 10:
        case 11:
            ...
            sUnknown_203B20C->unkF0.a0[1] = sUnknown_80DB7B8;
            sUnknown_203B20C->unkF0.a0[2] = sUnknown_80DB7B8;
            sUnknown_203B20C->unkF0.a0[0] = sUnknown_80DB800;
            break;
        case 12:
            sUnknown_203B20C->unkF0.a0[1] = sUnknown_80DB818;
            break;
        case 6:
        case 13:
            sUnknown_203B20C->unkF0.a0[2] = sUnknown_80DB7E8;
            break;
        default:
        case KANGASKHAN_STORAGE_2_INIT:
            for (index = 0; index < 4; index++)
                sUnknown_203B20C->unkF0.a0[index] = sUnknown_80DB7B8;
            break;
    }
    ResetUnusedInputStruct();
...
static void sub_8018100(void)
{
    switch (sUnknown_203B20C->state) {
        ...
        case 12:
            ...
            sUnknown_203B20C->unkC0.unk18 = &sUnknown_203B20C->unkF0.a0[1];
