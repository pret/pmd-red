...
ALIGNED(4) static const u8 gUnknown_80D4668[] = _(
    "{CENTER_ALIGN}Your adventure has been saved.\n"
...
ALIGNED(4) static const u8 gSaveNotWritten2[] = _(
...
ALIGNED(4) static const u8 gSaveFailed2[] = _("{CENTER_ALIGN}Save failed.");