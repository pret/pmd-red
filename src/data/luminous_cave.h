ALIGNED(4) static const u8 sLuminousCaveSeekAwakening[] = _(
...
ALIGNED(4) static const u8 sLuminousCaveAskEvolution[] = _(
	 "{CENTER_ALIGN}Do ye seek evolution?");

ALIGNED(4) static const u8 sLuminousCaveEvolutionInfo[] = _(
...
ALIGNED(4) static const u8 sLuminousCaveComeAlone[] = _(
...
ALIGNED(4) static const u8 sLuminousCaveLackLevel[] = _(
	 "{CENTER_ALIGN}...{EXTRA_MSG}"
	 "{CENTER_ALIGN}Ye cannot evolve yet.{EXTRA_MSG}"
	 "{CENTER_ALIGN}Ye have not high enough a level.");

ALIGNED(4) static const u8 sLuminousCaveCantEvolveAnymore[] = _(
	 "{CENTER_ALIGN}...{EXTRA_MSG}"
	 "{CENTER_ALIGN}Ye cannot evolve anymore.");

ALIGNED(4) static const u8 sLuminousCaveLackFriendArea[] = _(
	 "{CENTER_ALIGN}...{EXTRA_MSG}"
	 "{CENTER_ALIGN}Ye cannot evolve yet.{EXTRA_MSG}"
	 "{CENTER_ALIGN}Ye need your Friend Area to evolve.");

ALIGNED(4) static const u8 sLuminousCaveLackRoom[] = _(
	 "{CENTER_ALIGN}...{EXTRA_MSG}"
	 "{CENTER_ALIGN}Ye cannot evolve yet.{EXTRA_MSG}"
	 "{CENTER_ALIGN}The Friend Area to which ye shall go\n"
	 "{CENTER_ALIGN}has no room for ye.");

ALIGNED(4) static const u8 sLuminousCaveLackIQ[] = _(
	 "{CENTER_ALIGN}...{EXTRA_MSG}"
	 "{CENTER_ALIGN}Ye cannot evolve yet.{EXTRA_MSG}"
	 "{CENTER_ALIGN}Ye seem to lack the IQ to evolve.");

ALIGNED(4) static const u8 sLuminousCaveLackItem[] = _(
	 "{CENTER_ALIGN}{CENTER_ALIGN}...{EXTRA_MSG}"
	 "{CENTER_ALIGN}Ye cannot evolve yet.{EXTRA_MSG}"
	 "{CENTER_ALIGN}Ye seem to lack an item to evolve.");

ALIGNED(4) static const u8 sLuminousCaveCantEvolveYet[] = _(
	 "{CENTER_ALIGN}{CENTER_ALIGN}...{EXTRA_MSG}"
	 "{CENTER_ALIGN}Ye cannot evolve yet. ");

ALIGNED(4) static const u8 sLuminousCaveGiveName[] = _(
