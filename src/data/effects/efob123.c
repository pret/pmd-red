...
const RGB_Struct gUnknown_9845254[] = INCBIN_U8("data/effects/efob123.pmdpal");
const ax_pose *const gUnknown_9845294[] = {
    gUnknown_9844EEC,
    gUnknown_9844F1E,
};
const ax_anim *const gUnknown_984529C[] = {
    gUnknown_9844F38,
    gUnknown_9844F38,
    gUnknown_9844F38,
    gUnknown_9844F38,
...
const ax_anim *const *const gUnknown_98452BC[] = {
    gUnknown_984529C,
};
