...
static const struct ScriptCommand s_gs2_g1_s0_lives0_dlg2[] = { /* 0x817e130 */
    ...
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" I went into the cave, but...{WAIT_PRESS}\nI couldn't evolve into Butterfree.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Oh, so it's my level!{WAIT_PRESS}\nI get it! I'll work at leveling up!") },
...
static const struct ScriptCommand s_gs2_g3_s0_lives0_dlg2[] = { /* 0x817e834 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hohoho!{WAIT_PRESS}\nYou look eager to go.") },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Without {COLOR GREEN_I}Dive{RESET}, you cannot\ngo to the {COLOR YELLOW_D}Stormy Sea{RESET}.") },
    { 0x2e, 0x15,  0x0001,  0x00000001,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hohoho! Your face tells me\nyou are desperate to go.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" So be it.{WAIT_PRESS}\nYou may have this.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(20),
  ...
  LABEL(0), /* = 0x00 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" The Hidden Machine {COLOR GREEN_I}Dive{RESET}\nwas apparently found in the {COLOR YELLOW_D}Solar Cave{RESET}.") },
...
static const struct ScriptCommand s_gs2_g6_s0_lives0_dlg0[] = { /* 0x817f910 */
    ...
    { 0x2e, 0x02,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x03,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Listen, {NAME_3}.{WAIT_PRESS}\nWe must keep this a secret just between\nthe two of us.") },
...
static const struct ScriptCommand s_gs2_g8_s0_lives0_dlg0[] = { /* 0x8180674 */
    ...
    { 0x2e, 0x02,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x03,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" {NAME_3}, listen.{WAIT_PRESS}\nI'm thinking it is best if only we go\ninto the dungeon.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" If either one of us\nfalls before the end...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Oh, I get it.{WAIT_PRESS}\nThe other one can still go make wishes!") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" That's smart, {NAME_2}!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x2e, 0x15,  0x0002,  0x00000001,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs2_g12_s0_lives0_dlg2[] = { /* 0x8181c58 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" When I was small...{WAIT_PRESS}\nI was tiny...{WAIT_PRESS}\nHohoho.") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs2_g12_s0_lives1_dlg2[] = { /* 0x8181d6c */
    ...
    { 0x2d, 0x09,  0x0003,  0x0000005e,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh! {NAME_0} and\n{NAME_2}! Long time no see!") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I have a new friend!") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" His name is {NAME_3}.") },
...
static const struct ScriptCommand s_gs2_g13_s0_lives0_dlg2[] = { /* 0x8181f38 */
    ...
    { 0x2d, 0x09,  0x0002,  0x00000036,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I've not seen {NAME_2}\nor other children lately.\nI wonder how they are keeping.") },
...
static const struct ScriptCommand s_gs2_g14_s0_lives1_dlg2[] = { /* 0x81824b4 */
    ...
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I can play with {NAME_2}\nagain!") },
...
static const struct ScriptCommand s_gs2_g15_s0_lives1_dlg2[] = { /* 0x8182768 */
    ...
    { 0x2e, 0x02,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x03,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Yay, {NAME_3}!\nWhat'll we do next?") },
...
static const struct ScriptCommand s_gs2_g16_s0_lives0_dlg2[] = { /* 0x8182a70 */
  ...
  LABEL(1), /* = 0x01 */
    BGM_FADEOUT(90),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hohoho. Fine, then.{WAIT_PRESS}\nLet me recount the tale.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs2_g16_s0_lives1_dlg2[] = { /* 0x8182ce8 */
    ...
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" {NAME_2} told us\nfolklore from long ago.") },
...
static const struct ScriptCommand s_gs2_g16_s1_lives0_dlg0[] = { /* 0x8182f18 */
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Now, {NAME_2} had\nmany tails, all of them imbued with\npsychic power...") },
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" To {NAME_4}, that human\nwas her partner.") },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Taking pity on {NAME_4},\n{NAME_2} asked the human this...") },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" {NAME_2} became\ndisillusioned with the human...") },
    ...
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" What?!{WAIT_PRESS}\nA human turn into a Pokémon?!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(20),
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs2_g18_s0_lives0_dlg0[] = { /* 0x8183f98 */
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" To {NAME_3}, that human\nwas her partner.") },
...
static const struct ScriptCommand s_gs2_g20_s0_lives0_dlg2[] = { /* 0x81843a8 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I regret this...{WAIT_PRESS}\nHow some old folklore I told...{WAIT_PRESS}\ncould cause such an uproar...") },
...
static const struct ScriptCommand s_gs2_g20_s0_lives1_dlg2[] = { /* 0x8184568 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I'm so glad {NAME_0}\nisn't under suspicion anymore.") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs2_g20_s0_lives2_dlg2[] = { /* 0x81845fc */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I just knew {NAME_0}\ncouldn't be evil.") },
...
static const struct ScriptCommand s_gs2_g21_s0_lives0_dlg2[] = { /* 0x8184754 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" My whiskers...{WAIT_PRESS}\nThey tell me of coming earthquakes.") },
...
static const struct ScriptCommand s_gs2_g21_s0_lives2_dlg2[] = { /* 0x81849e0 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I couldn't take a step...{WAIT_PRESS}\nI was just shaking inside my shell...") },
...
static const struct ScriptCommand s_gs2_g23_s0_lives0_dlg2[] = { /* 0x8184e44 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I shouldn't be panicking.{WAIT_PRESS}\nI have the ability to sense quakes.\nI must remain calm.") },
...
static const struct ScriptCommand s_gs2_g24_s0_lives0_dlg2[] = { /* 0x8185214 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I can feel their resolve...{WAIT_PRESS}\nThe same feeling...from everyone.\nSniffle...") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs2_g24_s0_lives1_dlg2[] = { /* 0x81853ec */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Mom also told me...{WAIT_PRESS}\nIt is hard going because there are so many\nmonster houses.") },
...
static const struct ScriptCommand s_gs2_g26_s0_lives1_dlg2[] = { /* 0x8185aa0 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But this is {NAME_0}\nand {NAME_2}.{WAIT_PRESS}\nYou can't fail.") },
...
static const struct ScriptCommand s_gs2_g26_s0_lives2_dlg2[] = { /* 0x8185bac */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" You also have my support.{WAIT_PRESS}\nPlease do your best. And please be careful!") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs2_g27_s0_lives0_dlg2[] = { /* 0x8185d90 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Ah...{WAIT_PRESS} The {COLOR YELLOW_D}Sky Tower{RESET},\nyou say...") },
...
static const struct ScriptCommand s_gs2_g27_s0_lives1_dlg2[] = { /* 0x8185edc */
    ...
    { 0x2d, 0x09,  0x0002,  0x00000022,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" This is {NAME_0}\nand {NAME_2} after all.{WAIT_PRESS}\nYou can't fail.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I believe in you.\nSo I'll be waiting for you.") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs2_g29_s0_lives0_dlg0[] = { /* 0x81863ec */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hi, {NAME_4}!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0004,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Whaaaat?!{WAIT_PRESS}\nYou're Snubbull?") },
    ...
    { 0xe4, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0005,  0x00000000,  0x00000000, _(" Yup.{WAIT_PRESS}\nAnd I came out looking like this...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0009,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" I wish...{WAIT_PRESS}\nI want to be Butterfree quickly...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0005,  0x00000000,  0x00000000, _(" W-wait a second.{WAIT_PRESS}\nI don't know if I like this or not...") },
    ...
    { 0xe4, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    CALL_SCRIPT(NOTICE_FUNC),
    { 0x34, 0x00,  0x0005,  0x00000000,  0x00000000, _(" Oh! Really?!{WAIT_PRESS}\nI...{WAIT_PRESS} I might be stronger?!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    ...
    { 0xe4, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0004,  0x00000000,  0x00000000, _(" Yes.{WAIT_PRESS}\nBut it would depend on the conditions.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
