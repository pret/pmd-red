...
static const ScriptRef s_gs7_g0_s0_evt0_sref = { GETOUT_NORMAL, SCRIPT_TYPE_02, NULL, s_gs7_g0_s0_evt0_sref_script }; /* 0x819a5b0 */
...
static const ScriptRef * const (sStationScripts[]) = { /* 0x819a6a8 */
...
const GroundScriptHeader gGroundScript_gs7 = { LPARRAY(s_gs7_groups), s_gs7_links }; /* 0x819a73c */
