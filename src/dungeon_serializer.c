...
static void WriteMonster(DataSerializer *seri, Entity *src)
{
    ...
    if (EntityExists(src)) {
        ...
        info = &info2;
        WriteBytes(seri,&uStack_a8,1);
        WriteBytes(seri,&uStack_a8,1);
        WriteBytes(seri,&uStack_a8,1);
        WriteBytes(seri,&uStack_a8,1);
        WriteBytes(seri,&uStack_a8,2);
    }
    ...
    for (counter = 0; counter < NUM_PREV_POS; counter++) {
        WriteTilePos(seri, pos);
        pos++;
    }

    WriteAITarget(seri,temp3);
    WriteIQSkills(seri,temp2);
    WriteIQSkills(seri,temp1);
    WriteTactic(seri,*puStack_a0);
    WriteHiddenPower(seri,psStack_a4);
    WriteU32(seri,*puStack_9c);
    WriteU32(seri,*puStack_98);
    WriteU32(seri,*puStack_94);
    WriteSleep(seri,puStack_8c);
    WriteNonVolatile(seri,puStack_88);
    WriteImmobilize(seri,puStack_84);
    WriteVolatile(seri,puStack_80);
    WriteCharging(seri,puStack_7c);
    WriteProtection(seri,puStack_78);
    WriteWaiting(seri,puStack_74);
    WriteLinked(seri,puStack_70);
    WriteMoveStatus(seri,puStack_6c);
    WriteItemStatus(seri,puStack_68);
    WriteTransformStatus(seri,puStack_64);
    WriteEyesightStatus(seri,puStack_60);
    WriteMuzzled(seri,pbStack_5c);
    WriteBool8(seri,*pbStack_58);
    WriteBool8(seri,*pbStack_54);
    WriteBool8(seri,*pbStack_50);
    WriteBool8(seri,*puStack_4c);
    WriteBool8(seri,*pbStack_48);
    WriteU8(seri,*puStack_34);
    WriteBool8(seri,*pbStack_44);
    WriteBool8(seri,*pbStack_40);
    WriteBool8(seri,*pbStack_3c);
    WriteU8(seri,*puStack_38);
    WriteBool8(seri,*pbStack_30);
    WriteU8(seri,*puStack_2c);
    WriteU8(seri,*puStack_28);
    WriteMonsterUnkFF(seri,*puStack_24);
    ...
    WriteClientType(seri, *puStack_90);
}
