...
static void sub_802C928(void)
{
    ...
    switch (sUnknown_203B2F0->state) {
        case 2:
            sub_802CAA4();
            sUnknown_203B2F0->unk19C.a0[2] = sUnknown_80DFD40;
            sub_8012CAC(&sUnknown_203B2F0->unk19C.a0[2], sUnknown_203B2F0->unk10C);
            break;
        case 3:
            sUnknown_203B2F0->unk19C.a0[3] = sUnknown_80DFD58;
            break;
        default:
            for (i = 0; i < 4; i++)
                sUnknown_203B2F0->unk19C.a0[i] = sUnknown_80DFD28;
            break;
    }
