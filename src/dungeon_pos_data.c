...
const DungeonPos gAdjacentTileOffsets[NUM_DIRECTIONS] = {
    [DIRECTION_SOUTH] = {0, 1},
...
const u8 gUnknown_80F4D64[NUM_DIRECTIONS][4] = {
    [DIRECTION_SOUTH] = {DIRECTION_EAST, DIRECTION_WEST, DIRECTION_NORTH, DIRECTION_SOUTH},
    [DIRECTION_SOUTHEAST] = {DIRECTION_EAST, DIRECTION_SOUTH, DIRECTION_NORTH, DIRECTION_WEST},
    [DIRECTION_EAST] = {DIRECTION_NORTH, DIRECTION_SOUTH, DIRECTION_WEST, DIRECTION_EAST},
    [DIRECTION_NORTHEAST] = {DIRECTION_NORTH, DIRECTION_EAST, DIRECTION_WEST, DIRECTION_SOUTH},
    [DIRECTION_NORTH] = {DIRECTION_WEST, DIRECTION_EAST, DIRECTION_SOUTH, DIRECTION_NORTH},
    [DIRECTION_NORTHWEST] = {DIRECTION_WEST, DIRECTION_NORTH, DIRECTION_EAST, DIRECTION_SOUTH},
    [DIRECTION_WEST] = {DIRECTION_SOUTH, DIRECTION_NORTH, DIRECTION_EAST, DIRECTION_WEST},
    [DIRECTION_SOUTHWEST] = {DIRECTION_SOUTH, DIRECTION_WEST, DIRECTION_EAST, DIRECTION_NORTH}
};
