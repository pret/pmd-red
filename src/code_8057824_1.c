...
"_0808B208:\n"
	...
	"\tb _0808B2A8\n"
	"\t.align 2, 0\n"
"_0808B21C: .4byte dungeonGlobalData\n"
...
void sub_808B3E4(u8 param_1,u8 param_2,u8 param_3)
{
  ...
  if (((((param_2 * 0x1000000) + 0xcf000000U) >> 0x18) < 2) && (param_1 == 0x1A)){
    ...
    if (param_3 != 0) {
      ...
      uVar1 = dungeonGlobalData->unk1356C;
      ...
      dungeonGlobalData->unk1356C = uVar1;
      sub_8040A84();
    }
  }
}
...
void sub_808B3E4(u8 param_1, u8 param_2, u8 param_3)
{
	...
	"\tb _0808B44E\n"
	"\t.align 2, 0\n"
"_0808B414: .4byte dungeonGlobalData\n"
"_0808B418:\n"
	"\tldr r0, _0808B434\n"
	"\tldr r0, [r0]\n"
	"\tldr r1, _0808B438\n"
	...
	"\tb _0808B440\n"
	"\t.align 2, 0\n"
"_0808B434: .4byte dungeonGlobalData\n"
...
"_0808B44E:\n"
	...
	"\tbx r0\n"
	"\t.align 2, 0\n"
"_0808B454: .4byte dungeonGlobalData\n"
