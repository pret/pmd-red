...
void PrepareQuickSaveWrite(u8 *r0, u32 r1, u8 r2)
{
    ...
    if (sQuickSaveWrite->unkC != 0)
        xxx_info_box_80141B4(sUnknown_80D45AC, 0, 0, 0x20);
    else
        xxx_info_box_80141B4(sUnknown_80D45AC, 0, 0, 0x20);
}
        ...
        case 2:
            ...
            switch (sQuickSaveWrite->quickSaveStatus) {
                case SAVE_COMPLETED:
                    ...
                    if (sQuickSaveWrite->unkC != 0)
                        xxx_info_box_80141B4(sUnknown_80D45F4, 0, 0, 0x301);
                    else
                        xxx_info_box_80141B4(sUnknown_80D4668, 0, 0, 0x301);
                ...
                default:
                    sub_80121E0(987657);
                    xxx_info_box_80141B4(sSaveFailed, 0, 0, 0x301);
                    sQuickSaveWrite->state = 3;
                    break;
            }
            sub_8014114();
