...
bool8 CreateIQSkillListMenu(s16 species, u32 index, u32 a2)
{
    ...
    sIQSkillListMenu->s24.s0.unk38 = &sIQSkillListMenu->s24.s0.unk3C.a0[index];
    RestoreUnkTextStruct_8006518(&sIQSkillListMenu->s24.s0.unk3C);
    sIQSkillListMenu->s24.s0.unk3C.a0[sIQSkillListMenu->s24.s0.unk34] = sUnknown_80DBDF0;
...
{
    if (sIQSkillListMenu != NULL) {
        sIQSkillListMenu->s24.s0.unk3C.a0[sIQSkillListMenu->s24.s0.unk34] = sUnknown_80DBDD8;
        ResetUnusedInputStruct();
        xxx_call_save_unk_text_struct_800641C(&sIQSkillListMenu->s24.s0.unk3C, TRUE, TRUE);
