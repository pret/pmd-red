...
static void sub_801E76C(void)
{
    sUnknown_203B268->unk9C.count = sUnknown_203B268->s0.input.unk20;
    sUnknown_203B268->unk9C.currId = sUnknown_203B268->s0.input.unk1E;
    sUnknown_203B268->unk9C.width = 15;
