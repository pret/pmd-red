...
const u16 gUnknown_9755F40[] = INCBIN_U16("data/effects/efbg002_unk10.bin");
const u16 gUnknown_9756340[] = INCBIN_U16("data/effects/efbg002_unkC.bin");
const struct Struct_8009A7C gUnknown_9756660 = {
    ARRAY_COUNT(gUnknown_9755E2C),
    gUnknown_9755E2C,
    ARRAY_COUNT(gUnknown_9756340),
    gUnknown_9756340,
    gUnknown_9755F40,
};
