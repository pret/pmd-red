...
const RGB gUnknown_981AF3C[] = INCBIN_U8("data/effects/efob092.pmdpal");
const ax_pose *gUnknown_981AF7C[] = {
    gUnknown_981AC70,
    gUnknown_981ACA2,
};
const ax_anim *gUnknown_981AF84[] = {
    gUnknown_981ACD8,
    gUnknown_981ACD8,
    gUnknown_981ACD8,
    gUnknown_981ACD8,
...
const ax_anim *const *gUnknown_981AFA4[] = {
    gUnknown_981AF84,
};
const EfoFileData gUnknown_981AFA8 = {
    ...
    gUnknown_981ACFC,
    gUnknown_981AF3C,
    ARRAY_COUNT(gUnknown_981ACFC) / 16, // 18
};
