...
const RGB gUnknown_983C1B4[] = INCBIN_U8("data/effects/efob115.pmdpal");
const ax_pose *gUnknown_983C1F4[] = {
    gUnknown_983BEE4,
    gUnknown_983BEF8,
    gUnknown_983BF16,
    gUnknown_983BF34,
};
const ax_anim *gUnknown_983C204[] = {
    gUnknown_983BF58,
    gUnknown_983BF58,
    gUnknown_983BF58,
    gUnknown_983BF58,
...
const ax_anim *const *gUnknown_983C224[] = {
    gUnknown_983C204,
};
const EfoFileData gUnknown_983C228 = {
    ...
    gUnknown_983BFF4,
    gUnknown_983C1B4,
    ARRAY_COUNT(gUnknown_983BFF4) / 16, // 14
};
