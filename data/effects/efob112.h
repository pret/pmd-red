...
const RGB gUnknown_9838A1C[] = INCBIN_U8("data/effects/efob112.pmdpal");
const ax_pose *gUnknown_9838A5C[] = {
    gUnknown_9838688,
    gUnknown_983869C,
    gUnknown_98386B0,
    gUnknown_98386C4,
...
const ax_anim *gUnknown_9838A70[] = {
    gUnknown_98386F0,
    gUnknown_98386F0,
    gUnknown_98386F0,
    gUnknown_98386F0,
...
const ax_anim *const *gUnknown_9838A90[] = {
    gUnknown_9838A70,
};
const EfoFileData gUnknown_9838A94 = {
    ...
    gUnknown_983875C,
    gUnknown_9838A1C,
    ARRAY_COUNT(gUnknown_983875C) / 16, // 22
};
