...
{
    /* 0x0 */ axdata axdata;
    /* 0x3C */ OpenedFile *spriteFile; // This might be a AnimatedColor instead and AnimatedColor.unk0 might be a OpenedFile* etc. See friend_areas_map_util.AnimateSprites()
