...
void xxx_info_box_80141B4(const u8 *, u32, struct MonPortraitMsg *, u16);
void sub_8014248(const u8 *, u32, u32, const MenuItem *, void *, u32, u32, struct MonPortraitMsg *, u32);
s32 sub_80144A4(s32 *);
